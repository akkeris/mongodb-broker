...
begin
    ...
    if (select count(*) from plans) = 0 then
        ...
        values 
            ('3b0e2912-e997-7134-afa4-ba55a9d5a755', '5ccf29e2-9d50-cc9f-8c2d-83060de3f8ef', 'shared', 'Shared', 'Mongodb shared instance',  '6.0', 'akkeris-mongodb', 'mongodb', 'Data Stores', 2500, 0, ,'', 'mongodb', '', 'false'),
            ('9724e28d-dd3d-0b42-835d-8b5d918c430a', '5ccf29e2-9d50-cc9f-8c2d-83060de3f8ef', 'high-availabilty', 'High-Availability', 'Mongodb with high availabity - 100gb',    '6.0', 'akkeris-mongodb', 'mongodb', 'Data Stores', 3500, 0, '', 'mongodb', '', false)
    end if;
end
$$
`
